...
pub struct ArtistBiographyUpdateBodyData {
    ...
    pub attributes: models::ArtistBiographyUpdateBodyDataAttributes,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
...
impl ArtistBiographyUpdateBodyData {
    pub fn new(attributes: models::ArtistBiographyUpdateBodyDataAttributes, id: String, r#type: TypeFalse) -> ArtistBiographyUpdateBodyData {
