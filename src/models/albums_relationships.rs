...
pub struct AlbumsRelationships {
    ...
    #[serde(rename = "items")]
    pub items: models::MultiRelationship<models::ResourceIdentifier<crate::apis::albums_api::AlbumsItemsResourceMeta>>,
    #[serde(rename = "owners")]
...
impl AlbumsRelationships {
    pub fn new(
        ...
        items: models::MultiRelationship<models::ResourceIdentifier<crate::apis::albums_api::AlbumsItemsResourceMeta>>,
