...
pub struct UserSharesMultiRelationshipDataDocument {
...
impl UserSharesMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> UserSharesMultiRelationshipDataDocument {
