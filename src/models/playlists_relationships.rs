...
impl PlaylistsRelationships {
    pub fn new(cover_art: models::MultiRelationshipDataDocument, items: models::PlaylistsItemsMultiRelationshipDataDocument, owners: models::MultiRelationshipDataDocument) -> PlaylistsRelationships {
