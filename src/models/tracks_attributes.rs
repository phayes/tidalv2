...
impl TracksAttributes {
    pub fn new(duration: String, explicit: bool, isrc: String, key: KeyFalse, key_scale: KeyScaleFalse, media_tags: Vec<String>, popularity: f64, title: String) -> TracksAttributes {
        TracksAttributes {
            access_type: None,
            availability: None,
            bpm: None,
