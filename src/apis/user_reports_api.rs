...
pub type UserReportsPostError = StandardApiError;


/// Creates a new userReport.
pub async fn user_reports_post(configuration: &configuration::Configuration, user_report_create_operation_payload: Option<models::UserReportCreateOperationPayload>) -> Result<models::UserReportsSingleResourceDataDocument, Error<UserReportsPostError>> {
