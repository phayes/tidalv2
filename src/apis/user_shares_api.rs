...
pub async fn user_shares_id_get(
    configuration: &configuration::Configuration,
    id: &str,
    include: Option<Vec<String>>,
...
pub async fn user_shares_id_relationships_owners_get(
    configuration: &configuration::Configuration,
    id: &str,
    include: Option<Vec<String>>,
    page_cursor: Option<&str>,
) -> Result<
    models::UserSharesMultiRelationshipDataDocument,
...
pub async fn user_shares_id_relationships_shared_resources_get(
    configuration: &configuration::Configuration,
    id: &str,
    page_cursor: Option<&str>,
    include: Option<Vec<String>>,
