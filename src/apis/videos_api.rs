...
pub async fn videos_id_get(
    ...
    id: &str,
    include: Option<Vec<String>>,
) -> Result<models::VideosSingleResourceDataDocument, Error<VideosIdGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_include = include;
...
) -> Result<models::VideosMultiRelationshipDataDocument, Error<VideosIdRelationshipsAlbumsGetError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_include = include;
...
pub async fn videos_id_relationships_artists_get(
    ...
    include: Option<Vec<String>>,
    page_cursor: Option<&str>,
) -> Result<models::VideosMultiRelationshipDataDocument, Error<VideosIdRelationshipsArtistsGetError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_include = include;
...
pub async fn videos_id_relationships_providers_get(
    ...
    models::VideosMultiRelationshipDataDocument,
