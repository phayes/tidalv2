...
pub type UserEntitlementsIdGetError = StandardApiError;


/// Retrieves single userEntitlement by id.
pub async fn user_entitlements_id_get(configuration: &configuration::Configuration, id: &str) -> Result<models::UserEntitlementsSingleResourceDataDocument, Error<UserEntitlementsIdGetError>> {
